...
<body>
    ...
    <nav class="bg-indigo-500">
        <div class="container py-2 mx-auto px-10 flex flex-wrap items-center justify-between">
            ...
            <button id="bntResponsive" class="p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-white" data-collapse-toggle="" type="button"  aria-controls="" aria-expanded="false">
    ...
    <div class="flex bg-gray-400 py-5">

        
    <?php require_once('./sidebar.html') ?>
    <?php require_once('./mis_cursos.html') ?>
